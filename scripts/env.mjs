...
export function gravarEnv(novos) {
  ...
  const linhas = [
    ...
    '',
    '# ID do SERVIDOR do Discord (a guild) cuja gente pode abrir a página',
    '# /servidor — a que mostra as salas abertas e quem está online, e de onde',
    '# saem os links de convite. Quem entrar com o Discord e não estiver nele',
    '# não passa da porta. Vazio = qualquer conta do Discord vê.',
    '# Onde pegar: com o Modo desenvolvedor ligado, botão direito no ícone do',
    '# servidor, "Copiar ID do servidor". Mais de um: separe por vírgula.',

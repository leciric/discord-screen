...
function anunciar(url, escreveu, clientId, temPainel) {
  ...
  // O painel só existe para quem o ligou, e o endereço dele muda junto com o do
  // túnel descartável — montá-lo de cabeça a cada reinício é o tipo de atrito
  // que faz não se olhar o painel nunca.
  if (temPainel) {
